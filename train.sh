...
CUDA_VISIBLE_DEVICES=0 python train.py -gpus 3 -model h_attention -log 5c_h_attention -notrain -restore checkpoint_best_15_4.590873.pt -beam_search
...
CUDA_VISIBLE_DEVICES=1 python train.py -gpus 1 -use_content -notrain -beam_search -restore checkpoint_best.pt \
  ...
  -tau 0.5 -gama1 0.0 -gama_kld 0.05 -gama_select 0.0 -gama_rank 0.1 -gama_reg 0.01
...
CUDA_VISIBLE_DEVICES=3 python train.py -gpus 1 -use_content -model var_select_var_user_diverse2seq_test2 -log xxx