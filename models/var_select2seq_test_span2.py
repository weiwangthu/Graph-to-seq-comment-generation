...
class var_select2seq_test_span2(nn.Module):

    def __init__(self, config, vocab, use_cuda, use_content=False, pretrain=None):
        super(var_select2seq_test_span2, self).__init__()
        self.vocab = vocab
    ...
    def encode(self, batch, is_test=False):
        ...
        return contexts, state, post_context_gates, comment_rep, kld_select, context_gates, l1_gates, pri_gates
