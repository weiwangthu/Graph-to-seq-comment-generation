...
class select2seq_encode2(nn.Module):

    def __init__(self, config, vocab, use_cuda, use_content=False, pretrain=None):
        super(select2seq_encode2, self).__init__()
        self.vocab = vocab
    ...
    def encode(self, batch, is_test=False):
        ...
        return all_contexts, state, context_gates
    ...
    def forward(self, batch, use_cuda):
        ...
        content_len, content_mask = batch.content_len, batch.content_mask
